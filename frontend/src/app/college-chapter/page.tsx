...
/**
 * CollegeChapters Component
 * Displays the college chapters along with a registration link.
 */
        ...
        <div className="grid grid-cols-[repeat(auto-fit,minmax(280px,1fr))] justify-center   gap-6">
          {colleges.map((college, index) => (
            <div key={index} className="relative">
              <Link
                href={college.comingSoon ?'#': `/college-chapter/${index}`}  // If the college is "coming soon", disable the link by setting href to "#"
                key={index}
