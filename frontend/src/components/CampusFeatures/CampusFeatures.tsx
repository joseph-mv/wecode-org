...
const FeatureSection = () => {
  ...
  return (
    ...
    "
      ...
      <img
        className="absolute right-0 bottom-0 h-28"
      ...
      >
        {features.map((feature, index) => (
          <div className="lg:flex-[20%] bg-red-200 lg:max-w-[300px] flex  justify-center">
            <div
              key={index}
              className="  w-[300px]  h-[200px] bg-white rounded-lg shadow-lg p-4 flex flex-col items-center"
            >
